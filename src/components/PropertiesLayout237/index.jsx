      ...
      <div className={props.className}>
        <div className="flex flex-col gap-4 items-center justify-start w-full">
          ...
          <div className="flex flex-col gap-6 items-center justify-start w-full">
            ...
            <Text
              className="leading-[150.00%] max-w-[1416px] md:max-w-full text-black-900 text-center text-lg"
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-6 items-center justify-start w-full">
              ...
              <div className="flex flex-col gap-6 items-center justify-start w-full">
                ...
                <Text
                  className="leading-[150.00%] max-w-[440px] md:max-w-full text-base text-black-900 text-center"
                  size="txtRobotoRegular16"
                >
